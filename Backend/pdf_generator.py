# Arquivo: backend/pdf_generator.py (VERSÃO FINAL com nome de arquivo robusto)
...
# Arquivo: backend/pdf_generator.py (com novo formato de nome de arquivo)
...
# ▼▼▼ FUNÇÃO ATUALIZADA PARA RECEBER O ID_MOTOR E USÁ-LO NO NOME DO ARQUIVO ▼▼▼
def gerar_relatorio_final(df_dados_brutos, dados_motor, checkboxes={}, id_motor=None):
    try:
        ...
        id_motor_safe = id_motor if id_motor else 'ID-Nao-Informado'
        ...
        # O novo nome agora inclui o ID do motor para uma referência única e segura
        nome_arquivo = f"RELATORIO_{id_motor_safe}_{nome_cliente_safe}_{descricao_motor_safe}_{mes_ref_safe}.pdf"
        # --- FIM DA ATUALIZAÇÃO ---
